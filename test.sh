...
assert "takeRightWhile" "$(Chars hello | (F(){ [[ "$1" != "e" ]]; }; stream.takeWhile F) | stream.mkString , [ ])" "[l,l,o]"
assert "dropRightWhile" "$(Chars hello | (F(){ [[ "$1" != "l" ]]; }; stream.dropWhile F) | stream.mkString , [ ])" "[h,e,l,l]"
